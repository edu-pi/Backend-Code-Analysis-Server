...
from app.visualize.analysis.stmt.parser.expr.models.expr_obj import RangeObj, NameObj
...
class ForHeaderConvertor:
    ...
    def _get_condition(target_name: str, iter_obj: RangeObj):
        ...
        elif isinstance(iter_obj, NameObj):
            return ForHeaderConvertor._get_name_condition(target_name, iter_obj)
        else:
    ...
    @staticmethod
    def _get_name_condition(target_name, iter_obj):
        # ['1','2','3'..]
