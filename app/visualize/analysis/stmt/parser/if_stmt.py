...
class IfStmt:
    ...
    @staticmethod
    def parse_if_condition(test_node: ast.expr, elem_manager: ElementContainer):
    ...
    @staticmethod
    def parse_elif_condition(test_node: ast.expr, elem_manager: ElementContainer):
    ...
    @staticmethod
    def _evaluate_test_value(test_node: ast.expr, elem_manager: ElementContainer):
        """
